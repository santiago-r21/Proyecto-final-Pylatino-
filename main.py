...
background = pygame.image.load("Proyecto-final-Pylatino-/imagenes/Menu.png").convert()
titulo = pygame.image.load("Proyecto-final-Pylatino-/imagenes/Titulo.png")
Fondo = pygame.image.load("Proyecto-final-Pylatino-/imagenes/Fondo.png").convert()
